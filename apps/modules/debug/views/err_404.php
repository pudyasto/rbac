<style>
    .error-text-2 {
            ...
            line-height: 1;
            letter-spacing: -.05em;
            background-image: -webkit-linear-gradient(92deg,#333,#999C9E);
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="text-center error-box">
                ...
                <h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> This Page <u>Doesn't</u> Exist</strong></h2>
                <br />
                <p class="lead">
                    Sorry, your request page is not found. Please contact your web administrator or wait for a while.
                    <br>
