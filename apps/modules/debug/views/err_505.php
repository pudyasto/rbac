    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="text-center error-box">
                <h1 class="error-text-2 bounceInDown animated"> Error 505 <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
                <h2 class="font-xl"><strong><i class="fa fa-fw fa-close fa-lg text-danger"></i> Access <u>Deny</u></strong></h2>
               <br />
                <p class="lead">
                    Please contact your web administrator or wait for a while.
                    <br>
                    Use <b>Back</b> button on your browser for go to previous page.
                </p>
                <p class="font-md">
                    <a href="<?=site_url('dashboard');?>" class="btn btn-default btn-lg">Back to Dashboard</a>
                </p>
                <br>
            </div>
        </div>
