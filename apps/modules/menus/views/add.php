        ...
        ?> 
          <div class="box-body">
            ...
            <div class="form-group form-mainmenu">
                <?php
                    echo form_dropdown($form['mainmenuid']['name'],$form['mainmenuid']['data'] ,$form['mainmenuid']['value'] ,$form['mainmenuid']['attr']);
                ?>
            </div>    
            <div class="form-group">
                <?php 
            ...
            <div class="form-group">
                <?php
                    echo form_dropdown($form['statmenu']['name'],$form['statmenu']['data'] ,$form['statmenu']['value'] ,$form['statmenu']['attr']);
                ?>
            </div>  
          </div>
          <!-- /.box-body -->
